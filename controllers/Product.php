...
class Product extends Controller{
    ...
    public function create(){
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $obj->insert($maloaisp,$masp, $tensp, $author, $publisher, $hinhanh, $soluong, $gianhap, $giaxuat, $khuyenmai, $mota, $ngaytao);
            header("Location: " . APP_URL . "/Product/");
            exit();
        }
   ...
   public function edit($masp){
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $obj->update($maloaisp,$masp, $tensp, $author, $publisher, $hinhanh, $soluong, $gianhap, $giaxuat, $khuyenmai, $mota, $ngaytao);
            header("Location: " . APP_URL . "/Product/");
            exit();
        }
        $this->view("adminPage", [
